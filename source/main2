...
class Utilisateurs(QtGui.QDialog):
     def __init__(self, parent, default_dir="."):
        ...
        self.setWindowTitle('Selectionnez votre systeme')
        self.create_widgets()
        self.layout_widgets()
        self.create_connections()
     def create_widgets(self):
        self.browser = QtGui.QTextBrowser()
        self.btnwindows=QtGui.QPushButton('Windows')
        self.btnlinux = QtGui.QPushButton('Linux')
        self.btnannuler =  QtGui.QPushButton('Annuler')
     def layout_widgets(self):
        self.resize(200, 200)
        self.boutonLayout = QtGui.QVBoxLayout()
        self.boutonLayout.addWidget(self.btnwindows)
        self.boutonLayout.addWidget(self.btnlinux)
        self.boutonLayout.addWidget(self.btnannuler)
        self.setLayout(self.boutonLayout)



     def create_connections(self):
        self.btnwindows.clicked.connect(self.windows)
        self.btnlinux.clicked.connect(self.linux)
...
class Form(QtGui.QWidget):
    ...
    def layout_widgets(self):
        ...
        self.btnuser.setToolTip('Inspection et analyse users')
        self.btnuser.setStatusTip('Inspection et analyse user')
    ...
    def show_user(self):
        ...
        if util.systeme ==2:
            ...
            diffusername()
            self.diff_type = 'listeresultat.txt'
        self.show_diff()
