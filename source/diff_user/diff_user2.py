...
class Diff_user2(object):
    def __init__(self, Source, Compare):
        self.filesDictA = {}
        self.filesDictB = {}
       ...
       #self.filesDictB = setmap(lines2)
        #self.filesDictA= setmap (lines)
        self.filesDictA = dict((el,0)for el in lines )
        self.filesDictB = dict((sel,0)for sel in lines2 )
        #alpha = dict(zip(a[0::1],a[0::1]))
...
def main():
    ...
    diff = Diff_user2(args.firstDir, args.secondDir)
    #diff = DiffFiles("./doc A/","./doc B/")
